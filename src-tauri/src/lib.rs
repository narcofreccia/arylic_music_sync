...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::streaming::add_manual_target,
            commands::streaming::remove_manual_target,
            commands::streaming::list_manual_targets,
            commands::streaming::list_target_delays,
            commands::streaming::set_target_delay,
